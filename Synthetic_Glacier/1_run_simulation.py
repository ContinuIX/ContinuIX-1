...
fig.suptitle("Bed configuration", y=1.02)
...
axes[2].set_title("Centreline profile")
axes[2].grid(alpha=0.3)

plt.tight_layout()
plt.savefig("./figures/bed_config.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved → ./figures/bed_config.png")
...
# Define WGS84 CRS
wgs84 = CRS.from_epsg(3857) # Example, not important
...
gmsh.write("./output/synthetic.msh")
...
mesh = firedrake.Mesh("./output/synthetic.msh")
...
firedrake.VTKFile("./output/b.pvd").write(b)
...
firedrake.VTKFile("./output/a.pvd").write(a_func)
...
hfile = firedrake.VTKFile("./output/h.pvd")
hfile.write(h0, time=0)
ufile = firedrake.VTKFile("./output/u.pvd")
ufile.write(u0, time=0)
fdfile = firedrake.VTKFile("./output/flux_div.pvd")
dhdtfile = firedrake.VTKFile("./output/dhdt.pvd")
...
fig_ev.suptitle("Ice thickness evolution over time")
...
plt.tight_layout()
plt.savefig("./figures/thickness_evolution.png", dpi=150, bbox_inches="tight")
plt.close(fig_ev)
print("Saved → ./figures/thickness_evolution.png")
...
plt.close(fig_snap)
print("Saved → ./figures/snapshots.png")
